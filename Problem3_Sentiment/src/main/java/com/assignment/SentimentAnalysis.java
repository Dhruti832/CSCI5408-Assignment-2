...
public class SentimentAnalysis {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Set<String> positiveWords = loadWords("../../../resources/positive-words.txt");

        // Step 2: Load negative words
        Set<String> negativeWords = loadWords("../../../resources/negative-words.txt");
        ...
        try (FileWriter fw = new FileWriter("sentiment_results.csv")) {
